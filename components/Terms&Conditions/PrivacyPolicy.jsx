...
function PrivacyPolicy() {
    ...
    return <>
        <Box component={'div'} sx={{
            width: '100%', backgroundColor: '#0A1227', pt: 16
        }} >
            <Container maxWidth="lg" sx={{
                ...
                <Typography variant="h3" sx={{
                    fontSize: "56px", color: '#FFFFFF', fontWeight: 700, lineHeight: "67.77px", fontStyle: 'normal', letterSpacing: '1%', mb: 8,textAlign:'center'
                ...
                <Typography variant="body" sx={{
                    ...
                    1.1 What's What. Eventbrite's products, features and offerings are available online through various Eventbrite properties including without limitation, Eventbrite, Eventbrite Communities, Eventbrite Music, Eventbrite Venue, Lanyrd, Rally, Ticketea, Ticketfly, Ticketscript Limited, nvite, Social Ads, and Eventbrite Boost ("Site(s)");
                    off platform, including without limitation, RFID, entry management, sponsorship and marketing or distribution services; and
                    through mobile applications, webpages, application programming interfaces, and subdomains ("Applications").<br />
                    online through various Eventbrite properties including without limitation, Eventbrite, Eventbrite Communities, Eventbrite Music, Eventbrite Venue, Lanyrd, Rally, Ticketea, Ticketfly, Ticketscript Limited, nvite, Social Ads, and Eventbrite Boost ("Site(s)");
                    off platform, including without limitation, RFID, entry management, sponsorship and marketing or distribution services; and
                    through mobile applications, webpages, application programming interfaces, and subdomains ("Applications").<br /><br />
                    1.2 Who's Who. When these Terms use the term "Organizer," we mean event creators using the Services to create events displayed on the Services for consumers using our Services (a) to consume information about or attend Events ("Consumers"), or (b) for any other reason. Organizers, Consumers and third parties using our Services are all referred to in these Terms collectively as "Users," "you" or "your."
                    <br />
                    When these Terms use the term "Eventbrite," "we," "us," or "our," that refers to Eventbrite, Inc. and its affiliates, and subsidiaries, and each of its and their respective officers, directors, agents, partners and employees. Affiliates include without limitation, Eventbrite Argentina, Eventbrite Brazil and Eventbrite US, as these entities are referenced below. The contracting entity on the other side of these Terms is as follows:
                    <br />
                    If you are a User located in Argentina, you are contracting with Eventbrite Argentina S.A. with head offices at República del Líbano Nº 981, Godoy Cruz, Province of Mendoza, Argentina, and registered under CUIT: 30-71038876-4 ("Eventbrite Argentina").
                    If you are a User located in Brazil, you are contracting with Eventbrite Brasil Gestao Online De Eventos Ltda., a limited liability company, with head offices in the city of São Paulo, State of São Paulo, Av. Faria Lima, 1306, 7º andar, Pinheiros, CEP 01451001, enrolled with the Taxpayer Registration CNPJ/MF under No. 15.913.672/0001-65 and with its Articles of Association registered with the Board of Commerce of the State of São Paulo under NIRE 35.226.513.555 ("Eventbrite Brazil").
